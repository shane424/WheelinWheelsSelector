...
describe('application interactions',()=>{
 ...
 it('supports simultaneous spin control',async()=>{render(<App/>);fireEvent.click(screen.getByText('Spin both'));await waitFor(()=>expect(screen.getByText(/plays/)).toBeTruthy())});
