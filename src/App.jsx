...
import { cloneDefaultConfig, configState, exportHistory, HISTORY_LIMIT, HISTORY_STORAGE_KEY, normalizeConfiguration, parseHistory, STORAGE_KEY } from './model';
...
export default function App(){
 ...
 <Modes groups={groups} terminology={metadata} onResult={addResult} reducedMotion={reducedMotion} disabled={state!=='ready'}/><Editor groups={groups} setGroups={setGroups} terminology={metadata} setTerminology={setMetadata}/>
